...
// Placeholder content — issues #9-#12 replace each quest's title/description/interaction.
// This shell only owns pagination, progress, skip and the completion flag.
const QUESTS = [
  { title: 'Quest 1', description: 'Coming soon.' },
  { title: 'Quest 2', description: 'Coming soon.' },
  { title: 'Quest 3', description: 'Coming soon.' },
  { title: 'Quest 4', description: 'Coming soon.' },
];

const QuestOnboarding = ({ isOpen, onComplete }) => {
  ...
  return <QuestOnboardingSteps onComplete={onComplete} />;
};

const QuestOnboardingSteps = ({ onComplete }) => {
